...
do
	...
	function RedBlackDBTree:Get(object : any) : any
		return self.Objects[object]
	end
	
	-- Determine if the tree has the given object
	function RedBlackDBTree:Contains(object : any) : boolean
		return self:Get(object) ~= nil
	end
	
	-- Update the tree by removing and re-adding the object. The items in the dictionary will be applied to the object
	function RedBlackDBTree:Update(object : any, dictionary : {})
	...
	function RedBlackDBTree:Add(newObject : any)
		...
		if self:Get(newObject) then return end
